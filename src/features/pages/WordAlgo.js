            ...
            <section className="content flex-content">
                <div>
                    ...
                    <div className="">
                        ...
                        <p>
                            The database allows us to create a dictionary of synonyms in which we can search for the best matches given a word 
                            provided at the command line. We take into account the window size, the encoding, the text file and the optional 
